...
export const documentLibrary: DocumentRequirement[] = [
  ...
  },
  {
    ...
    group: 'Income',
    labelEn: 'Benefits confirmation',
    labelHe: 'קצבאות',
    description: 'Income proof for benefit-supported borrowers.',
  ...
  },
  {
    ...
    labelHe: 'עובר ושב 3 חודש',
    description: 'Core financial capacity document.',
  },
  {
    code: 'loan-summary',
    group: 'Banking',
    labelEn: 'Existing loan summary',
    labelHe: 'ריכוז הלוואות',
    description: 'Existing liabilities and credit obligations.',
  },
  {
    code: 'sale-agreement',
    group: 'Property',
    ...
    labelHe: 'הסכם מכר',
    description: 'Required for purchase cases.',
