...
const n8nEnv = {
  ...
  AIRTABLE_DOCUMENT_LIBRARY_TABLE: appEnv.AIRTABLE_DOCUMENT_LIBRARY_TABLE,
  AIRTABLE_DOCUMENTS_TABLE: appEnv.AIRTABLE_DOCUMENTS_TABLE,
  AIRTABLE_BANK_RUNS_TABLE: appEnv.AIRTABLE_BANK_RUNS_TABLE,
  AIRTABLE_APPRAISERS_TABLE: appEnv.AIRTABLE_APPRAISERS_TABLE,
  AIRTABLE_APPRAISAL_JOBS_TABLE: appEnv.AIRTABLE_APPRAISAL_JOBS_TABLE,
